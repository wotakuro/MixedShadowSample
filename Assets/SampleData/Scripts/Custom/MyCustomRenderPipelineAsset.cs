...
namespace App
{
    ...
    public class MyCustomRenderPipelineAsset : RenderPipelineAsset
    {
        ...
        [MenuItem("Assets/Create/Rendering/MyCustomeRenderPipelineAsset", priority = CoreUtils.assetCreateMenuPriority1)]
        static void CreateMyPipeline()
        {
            ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0, CreateInstance<CreateMyPipelineAsset>(),
                "MyCustomeRenderPipe.asset", null, null);
        }
        ...
        class CreateMyPipelineAsset : EndNameEditAction
        {
            public override void Action(int instanceId, string pathName, string resourceFile)
            {
                var instance = CreateInstance<MyCustomRenderPipelineAsset>();
                /*
        ...
        {
            return new MyCustomRenderPipeline(this);
        }
        ...
        public int NoSelfShadowLayerMask
        {
            get
            {
